...
struct ImageTypeUnion {
  ...
  hyperionnet::RawImageT *AsRawImage() {
    return type == ImageType_RawImage ?
      reinterpret_cast<hyperionnet::RawImageT *>(value) : nullptr;
  }
  const hyperionnet::RawImageT *AsRawImage() const {
    return type == ImageType_RawImage ?
      reinterpret_cast<const hyperionnet::RawImageT *>(value) : nullptr;
  }
};
...
struct CommandUnion {
  ...
  hyperionnet::ColorT *AsColor() {
    return type == Command_Color ?
      reinterpret_cast<hyperionnet::ColorT *>(value) : nullptr;
  }
  const hyperionnet::ColorT *AsColor() const {
    return type == Command_Color ?
      reinterpret_cast<const hyperionnet::ColorT *>(value) : nullptr;
  }
  hyperionnet::ImageT *AsImage() {
    return type == Command_Image ?
      reinterpret_cast<hyperionnet::ImageT *>(value) : nullptr;
  }
  const hyperionnet::ImageT *AsImage() const {
    return type == Command_Image ?
      reinterpret_cast<const hyperionnet::ImageT *>(value) : nullptr;
  }
  hyperionnet::ClearT *AsClear() {
    return type == Command_Clear ?
      reinterpret_cast<hyperionnet::ClearT *>(value) : nullptr;
  }
  const hyperionnet::ClearT *AsClear() const {
    return type == Command_Clear ?
      reinterpret_cast<const hyperionnet::ClearT *>(value) : nullptr;
  }
  hyperionnet::RegisterT *AsRegister() {
    return type == Command_Register ?
      reinterpret_cast<hyperionnet::RegisterT *>(value) : nullptr;
  }
  const hyperionnet::RegisterT *AsRegister() const {
    return type == Command_Register ?
      reinterpret_cast<const hyperionnet::RegisterT *>(value) : nullptr;
  }
};
...
inline void Image::UnPackTo(ImageT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = data(); if (_e) _o->data.value = hyperionnet::ImageTypeUnion::UnPack(_e, data_type(), _resolver); }
...
inline flatbuffers::Offset<Clear> CreateClear(flatbuffers::FlatBufferBuilder &_fbb, const ClearT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _priority = _o->priority;
  return hyperionnet::CreateClear(
      _fbb,
      _priority);
}
...
inline flatbuffers::Offset<Color> CreateColor(flatbuffers::FlatBufferBuilder &_fbb, const ColorT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _data = _o->data;
  auto _duration = _o->duration;
  return hyperionnet::CreateColor(
      _fbb,
      _data,
      _duration);
}
...
inline void Request::UnPackTo(RequestT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = command(); if (_e) _o->command.value = hyperionnet::CommandUnion::UnPack(_e, command_type(), _resolver); }
}
...
inline flatbuffers::Offset<Request> CreateRequest(flatbuffers::FlatBufferBuilder &_fbb, const RequestT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return hyperionnet::CreateRequest(
      _fbb,
      _command_type,
      _command);
}
...
inline flatbuffers::Offset<void> ImageTypeUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    case ImageType_RawImage: {
      auto ptr = reinterpret_cast<const hyperionnet::RawImageT *>(value);
...
inline ImageTypeUnion::ImageTypeUnion(const ImageTypeUnion &u) : type(u.type), value(nullptr) {
  switch (type) {
    case ImageType_RawImage: {
      value = new hyperionnet::RawImageT(*reinterpret_cast<hyperionnet::RawImageT *>(u.value));
      break;
    }
    default:
      break;
...
inline void ImageTypeUnion::Reset() {
  switch (type) {
    case ImageType_RawImage: {
      auto ptr = reinterpret_cast<hyperionnet::RawImageT *>(value);
      delete ptr;
      break;
    }
    default: break;
...
inline flatbuffers::Offset<void> CommandUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    case Command_Color: {
      auto ptr = reinterpret_cast<const hyperionnet::ColorT *>(value);
      return CreateColor(_fbb, ptr, _rehasher).Union();
    }
    case Command_Image: {
      auto ptr = reinterpret_cast<const hyperionnet::ImageT *>(value);
      return CreateImage(_fbb, ptr, _rehasher).Union();
    }
    case Command_Clear: {
      auto ptr = reinterpret_cast<const hyperionnet::ClearT *>(value);
      return CreateClear(_fbb, ptr, _rehasher).Union();
    }
    case Command_Register: {
      auto ptr = reinterpret_cast<const hyperionnet::RegisterT *>(value);
...
inline CommandUnion::CommandUnion(const CommandUnion &u) : type(u.type), value(nullptr) {
  switch (type) {
    case Command_Color: {
      value = new hyperionnet::ColorT(*reinterpret_cast<hyperionnet::ColorT *>(u.value));
      break;
    }
    case Command_Image: {
      value = new hyperionnet::ImageT(*reinterpret_cast<hyperionnet::ImageT *>(u.value));
      break;
    }
    case Command_Clear: {
      value = new hyperionnet::ClearT(*reinterpret_cast<hyperionnet::ClearT *>(u.value));
      break;
    }
    case Command_Register: {
      value = new hyperionnet::RegisterT(*reinterpret_cast<hyperionnet::RegisterT *>(u.value));
      break;
    }
    default:
      break;
...
inline void CommandUnion::Reset() {
  switch (type) {
    case Command_Color: {
      auto ptr = reinterpret_cast<hyperionnet::ColorT *>(value);
      delete ptr;
      break;
    }
    case Command_Image: {
      auto ptr = reinterpret_cast<hyperionnet::ImageT *>(value);
      delete ptr;
      break;
    }
    case Command_Clear: {
      auto ptr = reinterpret_cast<hyperionnet::ClearT *>(value);
      delete ptr;
      break;
    }
    case Command_Register: {
      auto ptr = reinterpret_cast<hyperionnet::RegisterT *>(value);
      delete ptr;
      break;
    }
    default: break;
...
inline std::unique_ptr<hyperionnet::RequestT> UnPackRequest(
    const void *buf,
    const flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<hyperionnet::RequestT>(GetRequest(buf)->UnPack(res));
}

inline std::unique_ptr<hyperionnet::RequestT> UnPackSizePrefixedRequest(
    const void *buf,
    const flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<hyperionnet::RequestT>(GetSizePrefixedRequest(buf)->UnPack(res));
}
